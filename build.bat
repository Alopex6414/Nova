...
:build_debug
    ...
    echo [Build Debug]
    echo go build -o bin/nova.exe main.go
    go build -o bin/nova.exe main.go
    echo.
    echo.
...
:build_release
    ...
    echo [Build Release]
    echo go build -ldflags="-w -s" -o bin/nova.exe main.go
    go build -ldflags="-w -s" -o bin/nova.exe main.go
    echo.
    echo.
